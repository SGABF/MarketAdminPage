...
<script>
	...
	function goList(){
		SendPost("${pageContext.request.contextPath }/qna/qnaList",{"p":${cv.currentPage },"s":${cv.pageSize },"b":${cv.blockSize }},"post");
	}
</script>
<style type="text/css">
	* { font-size: 10pt; }
...
<body>
	<%-- ${cv } --%>
	<form action="${pageContext.request.contextPath}/qna/qnaInsertOk" method="post" enctype="multipart/form-data" onsubmit="return formCheck();" >
